...
class ActivateScreen extends StatefulWidget {
  @override
  State<ActivateScreen> createState() => _PasswordScreenState();
}

class _PasswordScreenState extends State<ActivateScreen> {
            ...
            Padding(
                ...
                child: PinCodeTextField(
                  ...
                  onChanged: (value) {
                    debugPrint(value);
                    setState(() {
                      controller.codeActivation=value;
                    });
                  },
                  ...
                  !reached
                      ...
                      : Row(
                        ...
                        children: [
                          CustomRounded(
                              text:
                              LocalString.getStringValue(context, 'resend') ?? "إعادة إرسال",
                              textSize: CommonConstants.textButton,
                              ...
                              pressed: () {
                                setState(() {
                                  reached=false;
                                  startTimer();
                                  controller.resendCode(context, controller);
                                });
