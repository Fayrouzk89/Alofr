...
class PrivacyScreen extends GetView<StatController> {
  @override
                    ...
                    children: <Widget>[
                      new Container(
                        ...
                        child: new Padding(
                          ...
                          Center(child: Html(data:widget.controller.data!.value!.data!.appPrivacy.toString())):
                          Text(''),
                        ),
                                /*
                                Expanded(
                                  child: Text(
                                    (widget.controller.data !=null &&  widget.controller.data!.value !=null)?
                                    widget.controller.data!.value!.data!.appPrivacy.toString()
                                        :
                                    "سياسة الخصوصية"
                                    ,
                                    maxLines: 7,
